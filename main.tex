...
Más de 3 años en soporte en sitio y remoto (L1 y algo de L2): mesa de ayuda, tickets/ITSM, resolución de incidencias y empatía con usuarios. De forma secundaria, mejora herramientas internas operativas con apoyo de IA (``vibecoding'') y nociones básicas de desarrollo. Busca crecer en soporte, service desk o soporte en campo en Oaxaca o remoto México.
...
\begin{itemize}
	\item Diagnóstico, reparación y mantenimiento de laptops y PCs
...
\begin{itemize}
	\item \textbf{Herramienta interna de inventario y mantenimientos (Angular + Supabase)} --- Mejorada en Herst como apoyo al soporte operativo: inventario de equipos, seguimiento de mantenimientos y bitácora; interfaz web con consumo de datos; vibecoding con IA (no portafolio de desarrollador).
\end{itemize}

\textbf{Fortalezas:} empatía y paciencia con usuarios; documentación / bitácora clara; aprendizaje continuo.
